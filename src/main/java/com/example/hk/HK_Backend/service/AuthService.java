    ...
    public boolean sendPasswordResetEmail(String email) {
        ...
        userRepository.findByEmail(email).ifPresent(user -> {
            ...
            String htmlBody = "<!DOCTYPE html><html><head><meta charset='UTF-8'/></head><body style='margin:0;padding:0;background:#f4f4f8;font-family:Segoe UI,Arial,sans-serif;'>"
                ...
                + "<td style='padding:0 6px;'><a href='https://wa.me/919579828996' style='display:block;width:44px;height:44px;background:#25d366;border-radius:10px;text-align:center;line-height:44px;text-decoration:none;font-size:22px;'>&#128172;</a></td>"
                + "<td style='padding:0 6px;'><a href='https://www.instagram.com/hkpg.akurdi' style='display:block;width:44px;height:44px;background:linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888);border-radius:10px;text-align:center;line-height:44px;text-decoration:none;font-size:22px;'>&#128247;</a></td>"
                + "<td style='padding:0 6px;'><a href='https://hk-pg-akurdi.vercel.app' style='display:block;width:44px;height:44px;background:linear-gradient(135deg,#d63384,#c026d3);border-radius:10px;text-align:center;line-height:44px;text-decoration:none;font-size:22px;'>&#127760;</a></td>"
                + "</tr></table>"
                + "</div>"
